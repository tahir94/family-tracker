...
export class HomePage {
	...
	constructor(private platform: Platform, private nativeGeocoder: NativeGeocoder, public alertCtrl: AlertController, private navParams: NavParams, public afAuth: AngularFireAuth, public navCtrl: NavController, menu: MenuController, public geolocation: Geolocation) {
		menu.enable(true);
		this.fetchGroups();
